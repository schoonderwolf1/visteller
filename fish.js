...
const VISSEN = [
{n:'Baars', lat:'Perca fluviatilis', foto:'./photos/baars.webp', audio:'./audio/baars.mp3',
...
{n:'Snoek', lat:'Esox lucius', foto:'./photos/snoek.webp', audio:'./audio/snoek.mp3',
...
{n:'Snoekbaars', lat:'Sander lucioperca', foto:'./photos/snoekbaars.webp', audio:'./audio/snoekbaars.mp3',
...
{n:'Blankvoorn', lat:'Rutilus rutilus', foto:'./photos/blankvoorn.webp', audio:'./audio/blankvoorn.mp3',
...
{n:'Ruisvoorn', lat:'Scardinius erythrophthalmus', foto:'./photos/ruisvoorn.webp', audio:'./audio/ruisvoorn.mp3',
...
{n:'Karper', lat:'Cyprinus carpio', foto:'./photos/karper.webp', audio:'./audio/karper.mp3',
...
{n:'Brasem', lat:'Abramis brama', foto:'./photos/brasem.webp', audio:'./audio/brasem.mp3',
...
{n:'Kolblei', lat:'Blicca bjoerkna', foto:'./photos/kolblei.webp', audio:'./audio/kolblei.mp3',
...
{n:'Zeelt', lat:'Tinca tinca', foto:'./photos/zeelt.webp', audio:'./audio/zeelt.mp3',
...
{n:'Paling', lat:'Anguilla anguilla', foto:'./photos/paling.webp', audio:'./audio/paling.mp3',
 vorm:{aal:1},
...
{n:'Winde', lat:'Leuciscus idus', foto:'./photos/winde.webp', audio:'./audio/winde.mp3',
...
{n:'Alver', lat:'Alburnus alburnus', foto:'./photos/alver.webp', audio:'./audio/alver.mp3',
